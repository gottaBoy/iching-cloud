package com.gottaboy.iching.auth.filter;
...
import com.gottaboy.iching.common.entity.constant.GrantTypeConstant;
    ...
    protected void doFilterInternal(@Nonnull HttpServletRequest httpServletRequest, @Nonnull HttpServletResponse httpServletResponse, @Nonnull FilterChain filterChain) throws ServletException, IOException {
        ...
        if (matcher.matches(httpServletRequest)
            ...
            try {
                ...
                IchingUtil.makeResponse(httpServletResponse, MediaType.APPLICATION_JSON_UTF8_VALUE,
                        HttpServletResponse.SC_INTERNAL_SERVER_ERROR, ichingResponse.message(e.getMessage()));
